...
| --- | --- | --- |
| Select Word | Ctrl+D | The current cursor select word highlight - Try more multiple types!! I though It was a bug because highlight multiple matching word and cursor are be able to replace words |
