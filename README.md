...
| --- | --- | --- |
| Select Word | Ctrl+D | Select word and highlight - Try more multiple types!! I though It was a bug because highlight multiple matching word and cursor are be able to replace words |
